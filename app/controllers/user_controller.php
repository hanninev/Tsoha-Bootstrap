<?php
  ...
  class UserController extends BaseController{
    ...
    public static function handle_login(){
      ...
      if(!$user) {
        View::make('login.html', array('errors' => array('Väärä käyttäjätunnus tai salasana!'), 'username' => $params['username']));
      } else {
    ...
    public static function store(){
      ...
      Redirect::to('/', array('message' => 'Tunnuksesi on luotu onnistuneesti.'));
    } else {
    ...
    public static function edit(){
      self::check_logged_in();
      View::make('user/edit.html', array('attributes' => self::get_user_logged_in()));
    }
    ...
    if(count($errors) > 0){
      ...
      $user->update();
        Redirect::to('/kayttaja', array('message' => 'Tietoja on muokattu onnistuneesti.'));
      }
    }
