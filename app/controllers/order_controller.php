...
class OrderController extends BaseController
{
    ...
    public static function show($id)
    {
        ...
        View::make('order/show.html', array(
            'order' => $order,
    ...
    public static function myOrders()
    {
        ...
        View::make('order/myOrders.html', array(
            'orders' => $orders
        ));
    }
    ...
    public static function arrivedOrders()
    {
        ...
        View::make('admin/arrivedOrders.html', array(
            'orders' => $orders
        ));
    }
    ...
    public static function cart()
    {
        ...
        if (isset($_SESSION['cart'])) {
            ...
            View::make('order/cart.html', array(
                'products' => $products,
    ...
    public static function removeFromCart($id)
    {
        ...
        if (isset($_SESSION['cart'])) {
            ...
            Redirect::to('/ostoskori', array(
                'message' => 'Tuote ' . $product->name . ' on poistettu ostoskorista.'
            ));
        }
    }
    ...
    public static function store()
    {
        ...
        if (count($errors) == 0) {
            ...
            $_SESSION['cart'] = null;
            Redirect::to('/', array(
                'message' => 'Tilaus on tehty onnistuneesti.'
            ));
        } else {
            Redirect::to('/ostoskori', array(
                'errors' => $errors,
